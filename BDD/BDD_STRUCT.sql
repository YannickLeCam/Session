...
-- Listage des données de la table sessionlecam.category : ~0 rows (environ)
...
-- Listage des données de la table sessionlecam.doctrine_migration_versions : ~1 rows (environ)
...
-- Listage des données de la table sessionlecam.intern : ~0 rows (environ)
INSERT INTO `intern` (`id`, `name`, `first_name`, `email`, `birthday`, `city`, `adress`, `gender`, `zip_code`) VALUES
...
-- Listage des données de la table sessionlecam.intern_session : ~1 rows (environ)
...
INSERT INTO `module_program` (`id`, `category_id`, `name`) VALUES
	(1, 1, 'PHP'),
	(2, 1, 'Javascript'),
	(3, 1, 'HTML'),
	(4, 1, 'CSS'),
...
-- Listage des données de la table sessionlecam.program : ~6 rows (environ)
INSERT INTO `program` (`id`, `session_id`, `module_id`, `duration`) VALUES
	(1, 1, 1, 6),
	(2, 1, 3, 12),
	(3, 1, 4, 16),
	(4, 1, 2, 2),
...
-- Listage des données de la table sessionlecam.session : ~2 rows (environ)
INSERT INTO `session` (`id`, `name`, `description`, `date_start`, `date_end`, `places`, `user_id`) VALUES
	(1, 'Dev web', 'Ouais le web c tro b1', '2024-08-02 00:00:00', '2024-09-02 00:00:00', 12, 1),
	(2, 'Bureatique', 'Word c tro de la balle ! en plus avec j\'excelle sur Excel', '2024-07-06 00:00:00', '2024-09-06 00:00:00', 15, 2);
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `first_name`, `name`) VALUES
...
-- Listage des données de la table sessionlecam.user_module_program : ~0 rows (environ)
INSERT INTO `user_module_program` (`user_id`, `module_program_id`) VALUES
	(1, 1),
	(1, 3),
	(1, 4),
	(2, 1),
